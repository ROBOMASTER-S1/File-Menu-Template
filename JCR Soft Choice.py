...
# I created this file menu and its files associated with it, using def functions().
# This Python file menu example shows how to create modules and
...
# want in your file menue. See my file menu folder image below:
...
exit J.C.R Soft~Choice.' # index 9 = text_words
    )
...
choice=('1','2','3','4','5','6','q') # choices, q = quit
